...
function CompanyData() {
  ...
  return (
    <div className='CompanyDataBody'>
        <div className='Nav'>
            ...
            <div className='bottom__nav'>
              <ul>
                <li><Link to='/company_data'>Comapany data</Link></li>
            ...
            <div className={showHamburger ? 'mobile__nav': 'mobile__nav__not__shown'}>
              <ul className={showHamburger ? 'monile__navigation__links__shown': 'monile__navigation__links_not_shown'}>
                <li><Link href='/company_data'>Comapany data</Link></li>
    ...
    <h2 className='data__title'>Company data</h2>
    <table className="fl-table">
        ...
        {companies.map((company, index) => (
          <tr key={index}>
          <td className='tableRow'>{company.company_name}</td>
          <td className='tableRow'>{company.address}</td>
          <td className='tableRow'>{company.city}</td>
          <td className='tableRow'>{company.postal_code}</td>
          <td className='tableRow'>{company.vat_number}</td>
          <td className='tableRow'>{company.nation}</td>
      </tr>
        ))}
